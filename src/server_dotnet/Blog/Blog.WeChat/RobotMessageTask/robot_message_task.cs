...
namespace Blog.WeChat.RobotMessageTask
{
    ...
    public partial class robot_message_task : BaseEntity
    {
        ...
        /// </summary>
        [DataMember]
        [Attr("robot_message_taskid", "实体id", DataType.Varchar, 100)]
        ...
        /// </summary>
        [DataMember]
        [Attr("runtime", "执行时间", DataType.Varchar, 100)]
        ...
        /// </summary>
        [DataMember]
        [Attr("message_typename", "消息类型名称", DataType.Varchar, 100)]
        ...
        /// </summary>
        [DataMember]
        [Attr("robotid", "机器人", DataType.Varchar, 100)]
        ...
        /// </summary>
        [DataMember]
        [Attr("robotidname", "机器人名称", DataType.Varchar, 100)]
        ...
        /// </summary>
        [DataMember]
        [Attr("job_state", "任务状态", DataType.Varchar, 100)]
        ...
        /// </summary>
        [DataMember]
        [Attr("job_statename", "任务状态名称", DataType.Varchar, 100)]
